...
public final class LoginHelper {
    ...
    private static JsonArray getXboxToken(String email, String password) throws AuthenticationException {
        ...
        HttpResponse<String> oauthResponse = sendRequest(MS_OAUTH_URL, "GET", null, null, 5000, BodyHandlers.ofString(StandardCharsets.UTF_8));
        ...
        // Login to Microsoft
        HttpResponse<String> loginResponse = sendRequest(
        ...
        HttpResponse<String> redirectResponse = sendRequest(
    ...
    private static Session getSessionFromXsts(String xstsId, String xstsToken) throws AuthenticationException {
        HttpResponse<String> mcResponse = sendRequest(
                MC_AUTH_URL,
                "POST",
                new String[] {
        ...
        HttpResponse<String> profileResponse = sendRequest(
    ...
    public static <T> HttpResponse<T> sendRequest(URI url, String method, String[] headers, String body, int timeout, HttpResponse.BodyHandler<T> handler) {
        return sendRequest(HTTP_CLIENT, url, method, headers, body, timeout, handler);
    }

    public static <T> HttpResponse<T> sendRequest(HttpClient client, URI url, String method, String[] headers, String body, int timeout, HttpResponse.BodyHandler<T> handler) {
        try {
