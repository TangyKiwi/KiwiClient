...
import com.tangykiwi.kiwiclient.mixin.BufferRendererMixin;
import com.tangykiwi.kiwiclient.mixininterface.ICapabilityTracker;
...
public class GL {
    ...
    public static void bindVertexArray(int vao) {
        ...
        if (changeBufferRenderer) BufferRendererMixin.setCurrentVertexArray(vao);
    }

    public static void bindVertexBuffer(int vbo) {
        GlStateManager._glBindBuffer(GL_ARRAY_BUFFER, vbo);
        if (changeBufferRenderer) BufferRendererMixin.setCurrentVertexBuffer(vbo);
    }

    public static void bindIndexBuffer(int ibo) {
        GlStateManager._glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, ibo);
        if (changeBufferRenderer) BufferRendererMixin.setCurrentElementBuffer(ibo);
    }
