...
import com.tangykiwi.kiwiclient.util.renderer.ByteTexture;
import com.tangykiwi.kiwiclient.util.renderer.Mesh;
...
public class Font {
    ...
    public double render(Mesh mesh, String string, double x, double y, CustomColor color, double scale) {
