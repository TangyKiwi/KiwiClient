...
public class Renderer2D {
    ...
    public void line(double x1, double y1, double x2, double y2, CustomColor color) {
        lines.line(
    ...
    public void boxLines(double x, double y, double width, double height, CustomColor color) {
    ...
    public void quad(double x, double y, double width, double height, CustomColor cTopLeft, CustomColor cTopRight, CustomColor cBottomRight, CustomColor cBottomLeft) {
        triangles.quad(
    ...
    public void texQuad(double x, double y, double width, double height, CustomColor color) {
        triangles.quad(
    ...
    public void texQuad(double x, double y, double width, double height, TextureRegion texture, CustomColor color) {
        triangles.quad(
    ...
    public void texQuad(double x, double y, double width, double height, double rotation, double texX1, double texY1, double texX2, double texY2, CustomColor color) {
    ...
    public void texQuad(double x, double y, double width, double height, double rotation, TextureRegion region, CustomColor color) {
