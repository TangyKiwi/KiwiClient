...
public class FakeEntity extends OtherClientPlayerEntity {

    public FakeEntity() {
        this(MinecraftClient.getInstance().player.getGameProfile());
    }

    public FakeEntity(GameProfile profile) {
    ...
    public FakeEntity(GameProfile profile, double x, double y, double z) {
    ...
    public void update() {
        MinecraftClient.getInstance().world.getEntityById(this.getEntityId());
    }
    public void despawn() {
