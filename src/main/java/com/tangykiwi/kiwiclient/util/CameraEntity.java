...
public class CameraEntity extends ClientPlayerEntity
{
    ...
    {
        super(mc, world, nethandler, stats, recipeBook, mc.player.isSneaking(), mc.player.isSprinting());
    }
    ...
    {
        double base = ((Freecam) KiwiClient.moduleManager.getModule(Freecam.class)).getSetting(0).asSlider().getValue();
