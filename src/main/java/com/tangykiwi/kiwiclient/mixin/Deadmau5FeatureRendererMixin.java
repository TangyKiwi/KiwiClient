...
public class Deadmau5FeatureRendererMixin {
    ...
    //     if (ears.isEnabled()) {
    //         return ItemRenderer.getItemGlintConsumer(vertexConsumerProvider, RenderLayer.getArmorCutoutNoCull(Textures.EARS), true, ears.getSetting("Glint").asToggle().getValue());
    //     }
    //     return original;
    // }
}
