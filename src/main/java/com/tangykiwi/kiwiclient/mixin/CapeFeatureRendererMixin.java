...
// public class CapeFeatureRendererMixin {
    ...
    //     if (cape.isEnabled() && playerEntityRenderState.playerName.equals(mc.player.getName())) {
    //         return cape.getCape();
    //     }
    //     return original;
    // }
    ...
    //     Cape cape = (Cape) KiwiClient.moduleManager.getModule(Cape.class);
    //     if (cape.isEnabled() && playerEntityRenderState.playerName.equals(mc.player.getName())) {
    //         return ItemRenderer.getItemGlintConsumer(vertexConsumerProvider, RenderLayer.getArmorCutoutNoCull(cape.getCape()), true, cape.getSetting("Glint").asToggle().getValue());
    //     }
    //     return original;
    // }
// }
