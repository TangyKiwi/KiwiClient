...
public abstract class ClickGuiWindow extends Window {
    ...
    public void fillGrey(MatrixStack matrix, int x1, int y1, int x2, int y2) {
        ...
        DrawableHelper.fill(matrix, x1, y1 + 12, x2, y1 + 13, ColorUtil.guiColour());
        /**
        ...
        DrawableHelper.fill(matrix, x1, y1, x1 + 1, y2, ColorUtil.guiColour());
        DrawableHelper.fill(matrix, x1, y2, x2 + 1, y2 - 1, ColorUtil.guiColour());
        DrawableHelper.fill(matrix, x2, y1, x1, y1 + 1, ColorUtil.guiColour());
        DrawableHelper.fill(matrix, x2, y2, x2 + 1, y1, ColorUtil.guiColour());
    }
